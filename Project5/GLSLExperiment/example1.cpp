...
{ 
	...
	glUniform1i(glGetUniformLocation(program, "textureMode"), mode);
...
keyboard( unsigned char key, int x, int y )
{
	...
	case 'W':
		mode = 6;
		glUniform1f(glGetUniformLocation(program, "uD"), 45.0);
		glUniform1f(glGetUniformLocation(program, "uR"), 0.5);
		display();
		break;
	case 'P':
		mode = 7;
